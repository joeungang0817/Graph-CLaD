...
def _geometry_boxes(env: Any, object_states: list[dict[str, Any]]) -> dict[str, dict[str, Any]]:
    """Capture conservative world AABBs for body-backed entities.
    ...
    exposes enough size information.
    """
...
def make_trajectory_snapshot(env: Any, observation: Any, step: int) -> dict[str, Any]:
    ...
    return {
        ...
        "geometry": _geometry_boxes(env, object_states),
